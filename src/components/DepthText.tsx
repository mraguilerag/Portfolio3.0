...
type DepthTextStyle = CSSProperties & {
  "--depth-text-perspective"?: string;
  "--depth-text-font-size"?: string;
  "--depth-text-font-weight"?: number | string;
  "--depth-text-face-color"?: string;
  "--depth-text-depth-color"?: string;
  "--depth-text-shadow"?: string;
};
