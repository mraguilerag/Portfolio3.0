...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement): { gl: any; ext: any } {
      ...
      if (!isWebGL2)
        gl =
          ...
          (canvas as any).getContext("experimental-webgl", params);
    ...
    function updatePointerMoveData(pointer: PointerPrototype, posX: number, posY: number, color: number[]) {
      pointer.prevTexcoordX = pointer.texcoordX;
      pointer.prevTexcoordY = pointer.texcoordY;
      pointer.texcoordX = posX / canvas!.width;
      pointer.texcoordY = 1.0 - posY / canvas!.height;
